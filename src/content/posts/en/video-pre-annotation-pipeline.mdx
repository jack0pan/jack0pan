---
title: "Phase 1: Notes from building a video pre-annotation pipeline"
...
Deep dive: [Why one episode becomes three Label Studio projects →](/en/posts/three-label-studio-projects/)

## Two independent frame rates

There are two fps knobs in this pipeline that look like one thing and aren't. Worth untangling:
...
Deep dive: [Two fps knobs in a video pre-annotation pipeline →](/en/posts/two-fps-knobs/)
...
Deep dive: [One module owns every path on disk →](/en/posts/one-module-owns-every-path/)
...
Deep dive: [Canonical filenames buy zero-config batching →](/en/posts/canonical-filenames-zero-config-batching/)
...
Deep dive: [Don't use Label Studio Source Storage for local files →](/en/posts/dont-use-label-studio-source-storage/)
...
Deep dive: [Four signals for review-frame sampling →](/en/posts/four-signal-frame-sampling/)
...
Deep dive: [Keep tests pure-Python with lazy imports →](/en/posts/lazy-imports-pure-python-tests/)
...
Phase-2 design notes (not shipped yet):
- [What counts as ground truth →](/en/posts/phase-2-ground-truth/)
- [Don't retrain on every export →](/en/posts/phase-2-retraining-cadence/)
- [The eval set must never see pre-annotations →](/en/posts/phase-2-clean-eval-set/)
- [Version the slice, not the snapshot →](/en/posts/phase-2-version-the-slice/)
